        ...
        <section>
            ...
            <div className="container">
                <form id="main-form" action="">
                    ...
                    <label className="main-form__label" for="estCivil">Estado Civil: </label>
                    ...
                    <label className="main-form__label" for="news">¿Desea recibir Newsletter? <input type="checkbox" name=""
                        id="news" /></label>
                    <label className="main-form__label" for="coments">Mensaje: </label><textarea className="main-form__textarea"
